  ...
  'targets': [
    {
      ...
      'sources': [
        ...
        'src/browser/login_database.cc',
        'src/browser/login_database.h',
        'src/browser/login_database_mac.cc',
        'src/browser/login_database_posix.cc',
        'src/browser/login_database_win.cc',
        ...
        'src/browser/password_store.cc',
        'src/browser/password_store.h',
        'src/browser/password_store_change.h',
        'src/browser/password_store_consumer.cc',
        'src/browser/password_store_consumer.h',
        'src/browser/password_store_default.cc',
        'src/browser/password_store_default.h',
